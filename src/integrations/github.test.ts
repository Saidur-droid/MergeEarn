...
import { parseGitHubIssueUrl, parseGitHubPullRequestUrl, getGitHubCheckStatus } from './github';
...
describe('getGitHubCheckStatus', () => {
  it('treats missing or unavailable check state as unknown rather than success', async () => {
    const status = await getGitHubCheckStatus('openai', 'openai', 456);
